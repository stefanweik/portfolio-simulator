...
def simulate_portfolio(stocks_weight, savings_weight, startup_weight, startups_weight, initial_amount, years):
    ...
    for year in range(years):
        ...
        startup_yearly_return = np.random.uniform(0.3, 0.55)  # Jährliche Rendite zwischen 30-70%
        ...
        if not startup_success and year == 0:
            ...
            startup_return = startup_yearly_return  # Random jährliche Rendite bei Erfolg
        else:
